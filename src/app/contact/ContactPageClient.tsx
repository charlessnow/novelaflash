...
export function ContactPageClient() {
  const contactMethods = [
    { method: "Email", value: "hello@novelaflash.com", label: "Consultas Generales" },
    { method: "X/Twitter", value: "@NovelaFlash", label: "Síguenos" },
    { method: "LinkedIn", value: "NovelaFlash Industry", label: "Red de la Industria" },
  ];
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-16">
            <ScrollReveal direction="left">
              <div className="card-glow rounded-3xl overflow-hidden bg-rp-bg-card p-12 border border-white/5 relative h-full">
                ...
                <h2 className="text-4xl font-display font-black text-white uppercase tracking-tight mb-8 italic">Contáctanos</h2>

                <form className="space-y-6 relative z-10" onSubmit={(e) => e.preventDefault()}>
                  <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                    <div className="space-y-2">
                      <label htmlFor="contact-name" className="text-[10px] text-rp-text-muted font-black uppercase tracking-[0.2em]">Nombre</label>
                      <input
                        id="contact-name"
                        type="text"
                    ...
                    <div className="space-y-2">
                      <label htmlFor="contact-email" className="text-[10px] text-rp-text-muted font-black uppercase tracking-[0.2em]">Correo</label>
                      <input
                        id="contact-email"
                        type="email"
                        className="w-full bg-white/5 border border-white/10 rounded-lg px-4 py-3 text-white focus:outline-none focus:border-rp-coral transition-all"
                  ...
                  <div className="space-y-2">
                    <label htmlFor="contact-subject" className="text-[10px] text-rp-text-muted font-black uppercase tracking-[0.2em]">Asunto</label>
                    <input
                      id="contact-subject"
                      type="text"
                      className="w-full bg-white/5 border border-white/10 rounded-lg px-4 py-3 text-white focus:outline-none focus:border-rp-coral transition-all"
                  ...
                  <div className="space-y-2">
                    <label htmlFor="contact-message" className="text-[10px] text-rp-text-muted font-black uppercase tracking-[0.2em]">Mensaje</label>
                    <textarea
                      id="contact-message"
                      rows={6}
            ...
            <ScrollReveal direction="right">
              <div className="flex flex-col gap-8 h-full justify-center">
                <h2 className="text-4xl font-display font-black text-white uppercase tracking-tight mb-4 italic">Otras formas de contactarnos</h2>
