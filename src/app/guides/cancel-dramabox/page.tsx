...
export default function CancelDramaBoxPage() {
  const guidePath = "/guides/cancel-dramabox";
  const breadcrumbSchema = createBreadcrumbList([
    { name: "Home", item: SITE_URL },
    { name: "Guides", item: `${SITE_URL}/guides` },
    { name: GUIDE_STRUCTURED_DATA["cancel-dramabox"].title, item: `${SITE_URL}${guidePath}` },
  ]);

  return (
    <div className="flex flex-col min-h-screen bg-rp-bg-primary">
      <JsonLd data={GUIDE_STRUCTURED_DATA["cancel-dramabox"].data} />
        ...
        <section className="max-w-7xl mx-auto px-6 mb-20">
          <ScrollReveal direction="up">
            ...
            <h1 className="font-display font-black text-6xl md:text-8xl uppercase tracking-tight text-white mb-6 leading-[1.1]">
              How to Cancel DramaBox Subscription
            </h1>
            <p className="text-rp-text-secondary text-xl font-medium max-w-3xl leading-relaxed">
              A complete step-by-step guide to canceling your DramaBox subscription on any device. Learn about refund policies, what happens after cancellation, and answers to common questions.
            </p>
          </ScrollReveal>
        </section>
            ...
            <div className="prose prose-invert max-w-none">
              ...
              <div className="mb-16">
                ...
                <p className="text-rp-text-secondary text-lg leading-relaxed mb-8">
                  If you subscribed to DramaBox through the Apple App Store, follow these steps to cancel your subscription:
                </p>
                ...
                <ol className="space-y-6 mb-12">
                  ...
                  <li className="flex gap-6">
                    ...
                    <div>
                      <h3 className="text-white font-bold text-lg mb-2">Find DramaBox</h3>
                      <p className="text-rp-text-secondary">Locate DramaBox in your active subscriptions list.</p>
                    </div>
                  </li>
                  <li className="flex gap-6">
              ...
              <div className="mb-16">
                ...
                <ol className="space-y-6 mb-12">
                  ...
                  <li className="flex gap-6">
                    <span className="font-display font-black text-2xl text-rp-coral flex-shrink-0">4</span>
                    <div>
                      <h3 className="text-white font-bold text-lg mb-2">Select DramaBox</h3>
                      <p className="text-rp-text-secondary">Tap on the DramaBox subscription from your list.</p>
                    </div>
                  </li>
                  <li className="flex gap-6">
                    <span className="font-display font-black text-2xl text-rp-coral flex-shrink-0">5</span>
              ...
              <div className="mb-16">
                ...
                <p className="text-rp-text-secondary text-lg leading-relaxed mb-8">
                  If you subscribed through the DramaBox website, you can manage your subscription directly:
                </p>
                ...
                <ol className="space-y-6 mb-12">
                  <li className="flex gap-6">
                    ...
                    <div>
                      ...
                      <p className="text-rp-text-secondary">Visit the DramaBox website and sign in with your credentials.</p>
                    </div>
                  </li>
                  <li className="flex gap-6">
                    <span className="font-display font-black text-2xl text-rp-coral flex-shrink-0">2</span>
              ...
              <div className="mb-16">
                ...
                <div className="space-y-6">
                  ...
                  <div className="glass p-8 rounded-2xl border-white/10">
                    ...
                    <p className="text-rp-text-secondary">Once your billing period ends, DramaBox will not charge you again. You'll revert to the free tier with more generous daily episodes and ads.</p>
                  </div>
              ...
              <div className="mb-16">
                <h2 className="font-display font-black text-4xl text-white uppercase tracking-tight mb-8">
                  DramaBox Refund Policy
                </h2>
                <p className="text-rp-text-secondary text-lg leading-relaxed mb-8">
                  DramaBox's refund policy depends on where you subscribed:
                </p>
                ...
                <div className="space-y-6">
                  <div className="glass p-8 rounded-2xl border-white/10">
                    ...
                    <p className="text-rp-text-secondary text-sm italic">Note: Refunds are handled by Apple, not DramaBox.</p>
                  </div>
                  ...
                  <div className="glass p-8 rounded-2xl border-white/10">
                    ...
                    <p className="text-rp-text-secondary text-sm italic">Note: Refunds are handled by Google, not DramaBox.</p>
                  </div>
                  
                  <div className="glass p-8 rounded-2xl border-white/10">
                    <h3 className="text-white font-bold text-lg mb-3">Web Subscription</h3>
                    <p className="text-rp-text-secondary">DramaBox's web subscription typically does not offer refunds for used services. However, if you experience billing errors or unauthorized charges, contact DramaBox support immediately.</p>
                  </div>
                </div>
              </div>
              ...
              <div className="mb-16">
                ...
                <div className="space-y-8">
                  ...
                  <div>
                    ...
                    <p className="text-rp-text-secondary leading-relaxed">
                      Refund eligibility depends on your payment method. Apple and Google offer refund windows (14 days and 48 hours, respectively), but DramaBox itself typically does not issue refunds for used services. If you believe you were charged in error, contact DramaBox support with your transaction details. For app store refunds, contact Apple or Google directly.
                    </p>
                  </div>
                  ...
                  <div>
                    ...
                    <p className="text-rp-text-secondary leading-relaxed">
                      No. Your watchlist, viewing history, and account data are permanently saved to your DramaBox account. When you resubscribe or log back in, all your information will be there. You can continue watching from where you left off.
                    </p>
                  </div>
                  ...
                  <div>
                    ...
                    <p className="text-rp-text-secondary leading-relaxed">
                      After canceling your subscription, you'll have access to the free tier, which typically allows 5-7 free episodes per day with ads. DramaBox's free tier is more generous than ReelShort's.
                    </p>
                  </div>
                  ...
                  <div>
                    ...
                    <p className="text-rp-text-secondary leading-relaxed">
                      Use the "Forgot Password" option on the DramaBox login screen. You'll receive an email with instructions to reset your password. If you don't receive the email, check your spam folder or contact DramaBox support.
                    </p>
                  </div>
                </div>
              </div>
              ...
              <div className="glass p-12 rounded-2xl border-white/10 bg-gradient-to-br from-rp-coral/5 to-transparent">
                ...
                <p className="text-rp-text-secondary leading-relaxed mb-6">
                  Canceling your DramaBox subscription is straightforward and can be done in just a few taps. Whether you're taking a break or switching to another platform, your account and data will remain safe. You can always resubscribe later without losing your progress.
                </p>
                <p className="text-rp-text-secondary text-sm">
                  If you encounter any issues during the cancellation process, reach out to DramaBox's customer support team for assistance.
                </p>
              </div>
            </div>
          </ScrollReveal>
