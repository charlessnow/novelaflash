...
const PLATFORM_REVIEWS: Record<string, {
  ...
  goodshort: {
    tagline: "La app de miniseries mejor calificada del momento",
    overview: "GoodShort, desarrollada por Singapore New Reading Technology Pte. Ltd., tiene el puntaje editorial más alto de NovelaFlash gracias a una calificación de 4.9 estrellas en la App Store (más de 505K reseñas) y 4.77 estrellas en Google Play (más de 4.1M reseñas), ambas inusualmente altas para la categoría. Con más de 81 millones de descargas e ingresos anuales estimados en $45 millones de dólares, ha escalado rápido sin perder sus calificaciones altas.",
    contentLibrary: "GoodShort se enfoca en géneros de romance, suspenso, fantasía y drama laboral, con una fuerte oferta de historias de romance con CEOs y amores prohibidos en episodios ajustados de 1 a 3 minutos. La calidad y el ritmo del contenido se mencionan constantemente como un punto fuerte en las reseñas de usuarios.",
    pricing: "Los episodios empiezan alrededor de 50 monedas y suben hasta 70+ conforme avanza la serie, con un paquete de $14.99 dólares que cubre aproximadamente 1,500 monedas. En abril de 2026, GoodShort agregó una suscripción VIP de $19.99/semana que generó reacciones negativas reales: sitios de reseñas independientes (Trustpilot la tiene en apenas 2.2 estrellas, muy por debajo de su 4.9 en la App Store) mencionan cargos con renovación automática, pérdida de monedas y dificultad para cancelar como quejas recurrentes de ese período.",
    verdict: "GoodShort se gana sus altas calificaciones por contenido y ritmo, pero vale la pena conocer la diferencia entre su puntaje en la App Store y su reputación en sitios de reseñas independientes antes de suscribirte. Presta atención a la renovación automática del VIP y confirma que la cancelación se haya procesado.",
    pros: ["El puntaje editorial más alto de NovelaFlash", "Escala masiva (más de 81M de descargas)", "Historias originales sólidas y bien ritmadas", "Calificaciones consistentemente altas en App Store y Google Play"],
    cons: ["El aumento de precio VIP de abril de 2026 generó quejas reales de usuarios", "Las reseñas independientes (Trustpilot) la califican mucho más bajo que las tiendas de apps", "Reportes de cargos por renovación automática y cancelaciones lentas", "El costo por episodio en monedas sube conforme avanza la serie"],
  },
  kalostv: {
    tagline: "Producción cinematográfica, precios impredecibles",
    overview: "KalosTV (listada en Google Play como Kalos_ShortTV) se ha ganado una reputación por dramas cinematográficos llenos de giros, con actuación y calidad de producción por encima del promedio. Es una plataforma de escala media: más de 5 millones de descargas e ingresos anuales estimados en $18 millones de dólares, con una calificación de 4.5 estrellas en la App Store (más de 11K reseñas) pero notablemente más baja en Google Play, con 3.7 estrellas (más de 41.8K reseñas), lo que sugiere una experiencia más difícil en Android.",
    contentLibrary: "El catálogo de KalosTV se centra en romance urbano, fantasía histórica, leyendas de hombres lobo y tramas de multimillonarios, en episodios rápidos de 1 a 2 minutos. Las reseñas destacan constantemente la calidad de la narrativa y la actuación como algo que la distingue de la competencia de bajo presupuesto.",
    pricing: "El costo en monedas sube de forma impredecible dentro de una serie (un patrón común es alrededor de 90 monedas subiendo a 95+), y las suscripciones cuestan $14.99 y $29.99/mes, con usuarios del nivel más alto reportando que igual llegan a límites de monedas. Desbloquear una serie completa puede llegar a costar más de $50 dólares, según reportes.",
    verdict: "KalosTV ofrece una calidad de producción genuinamente sólida, lo que explica su base de seguidores fiel, pero los precios son más difíciles de predecir que los de la mayoría de sus competidores, y los usuarios de Android reportan una experiencia más difícil que los de iOS. Conviene presupuestar bien antes de comprometerte con una serie completa.",
    pros: ["Calidad cinematográfica y buena actuación para la categoría", "Narrativa con giros que las reseñas mencionan por nombre", "Interfaz fácil de usar", "Algunos usuarios dicen que el contenido vale el precio"],
    cons: ["Calificación en Google Play notablemente más baja que en la App Store", "El precio en monedas sube de forma impredecible dentro de una serie", "Se reportan anuncios frecuentes e intrusivos", "Una serie completa puede costar $50+ desbloquearla, y el soporte puede ser difícil de contactar por temas de cobros"],
  },
  dreameshort: {
    tagline: "Respaldada por el catálogo de novelas de Dreame, con precio premium",
    overview: "DreameShort, publicada por CRATER PTE. LTD. como parte de la familia editorial de novelas web Stary/Dreame, adapta novelas bestseller de hombres lobo, mafia y romance urbano en episodios cortos. Tiene una calificación de 4.8 estrellas en la App Store (más de 101K reseñas) y 4.73 en Google Play (más de 570K reseñas), de las más altas en NovelaFlash, sobre una base más pequeña de 4.5M+ descargas e ingresos anuales estimados en $6 millones de dólares.",
    contentLibrary: "El catálogo abarca tramas de multimillonarios, identidades secretas, fantasía, venganza, hombres lobo y romance de mafia en episodios de 1 a 5 minutos, diseñados explícitamente para sesiones de duración de un traslado/commute. Las reseñas describen frecuentemente las historias como adictivas y la actuación como superior al promedio.",
    pricing: "DreameShort tiene el precio más alto de la categoría: las suscripciones cuestan $19.99/semana o $199/año, y el costo en monedas dentro de cada serie sube conforme avanzan los episodios (los rangos más citados van de 55 a 70, o de 69 a 72 monedas por episodio). Hay pocas formas confiables de conseguir monedas gratis.",
    verdict: "La calidad de contenido y las calificaciones de DreameShort son genuinamente sólidas, pero es una de las suscripciones más caras de la categoría con opciones limitadas de monedas gratis. Es una buena opción si específicamente quieres las historias adaptadas de novelas de Dreame y no te importa pagar precios premium por ellas.",
    pros: ["Calificaciones muy altas en App Store y Google Play", "Historias sólidas adaptadas de novelas (hombres lobo, mafia, romance urbano)", "Episodios descritos frecuentemente como adictivos", "Respaldada por una editorial de novelas web establecida"],
    cons: ["Entre las suscripciones más caras de la categoría ($19.99/semana)", "Pocas formas de conseguir monedas gratis", "Se reportan problemas de sincronización de compras entre iOS y Android", "Los agregadores de reseñas independientes la califican más bajo que las tiendas de apps (~3.7/5)"],
  },
  flickreels: {
    tagline: "Variedad de contenido global, a precio premium",
    overview: "FlickReels, publicada por FARSUN PTE. LTD. y disponible desde julio de 2024, ha escalado a cerca de 28 millones de descargas gracias a una calificación de 4.78 estrellas en la App Store (más de 86K reseñas) y 4.64 en Google Play (más de 590K reseñas). También tiene un canal de YouTube dedicado en español, una señal real de inversión deliberada en audiencias latinoamericanas más allá de solo traducir la app.",
    contentLibrary: "FlickReels se apoya en subtítulos y doblaje multilingüe con una biblioteca que abarca dramas chinos, coreanos, japoneses, españoles y tailandeses, con géneros que van desde romance y venganza hasta suspenso, intriga histórica y drama realista. Publica episodios nuevos cada día y tiene acuerdos de IP exclusivos para parte de su catálogo.",
    pricing: "Las suscripciones semanales llegan hasta $19.99 dólares y los paquetes de monedas hasta $29.99, con un nivel gratuito genuinamente generoso: al menos 10 episodios diarios con anuncios. Dicho esto, hay reportes de usuarios de que un paquete de $29.99 se agota en apenas 3 episodios en títulos más caros, así que el valor real depende mucho de qué serie estés viendo.",
    verdict: "FlickReels se gana sus altas calificaciones por la variedad de contenido y la calidad de video, y su inversión real en marketing en español la distingue de la mayoría de competidores de su tamaño. Aun así, conviene presupuestar bien los paquetes de monedas: el costo por episodio varía más de lo que sugieren los precios anunciados, y vale la pena estar atento a quejas de facturación.",
    pros: ["Buena calidad de video y producción", "Biblioteca de contenido global genuinamente diversa en varios idiomas", "Buen nivel gratuito diario (10+ episodios)", "Inversión real en marketing en español, algo inusual para una app de este tamaño"],
    cons: ["Los paquetes de monedas pueden agotarse rápido en títulos más caros ($29.99 durando apenas 3 episodios)", "Quejas de facturación: cargos no autorizados y puntos de bonificación que expiran", "Usuarios reportan que se les pide pagar de nuevo por episodios ya vistos tras vencer la suscripción", "Fallas ocasionales al reproducir recompensas por anuncios y problemas de inicio de sesión/cierres inesperados"],
  },
  playlet: {
    tagline: "Adictiva y accesible, pero de las apps más caras",
    overview: "Playlet, publicada por MicroShowtime Limited y disponible en Google Play desde diciembre de 2023, ha crecido a cerca de 5.7 millones de descargas con una calificación de 4.6 estrellas en la App Store (más de 44K reseñas) y 4.50 en Google Play (más de 140K reseñas). Su interfaz está disponible en 11 idiomas incluyendo español nativo, lo que la hace genuinamente accesible para audiencias latinoamericanas y no solo subtitulada.",
    contentLibrary: "El catálogo abarca suspenso, romance, comedia y más, con un modelo de \"abrir y ver\" que no requiere registro de cuenta para empezar a ver contenido, una ventaja real de comodidad para espectadores casuales que no quieren comprometerse desde el inicio.",
    pricing: "Los precios son inconsistentes y se reportan entre los más altos de la categoría: las ofertas VIP semanales van desde $10.99 hasta $19.99-$24.99 según la promoción, y hay usuarios que reportan aumentos de precio a mitad de sesión. Los paquetes de monedas rondan los $9.99 por 1,000 monedas, pero el costo por episodio escala; un usuario reportó necesitar 5,450 monedas para terminar una sola historia.",
    verdict: "La experiencia sin registro y el soporte multilingüe genuino de Playlet (incluyendo español nativo) hacen que sea fácil empezar a ver contenido, pero el precio es de los menos predecibles de la categoría. Conviene ir con la expectativa de pagar más de lo que sugiere el precio VIP anunciado, sobre todo en series largas.",
    pros: ["No requiere registro: se puede ver contenido de inmediato", "Interfaz nativa en español, no solo subtítulos", "Formato de miniserie adictivo y bien ritmado", "Variedad de contenido bien valorada entre suspenso, romance y comedia"],
    cons: ["Reportada ampliamente como una de las apps más caras de la categoría", "El precio en monedas por episodio es inconsistente y puede escalar fuerte en series largas", "Anuncios largos (120+ segundos) frente a episodios cortos (20-30 segundos)", "Reportes de aumentos de precio a mitad de sesión y dificultades para obtener reembolsos"],
  },
};
